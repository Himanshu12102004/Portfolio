  ...
  return (
    ...
    >
      ...
      <div className={`flex flex-col ${isMobile ? "items-center" : ""}`}>
        ...
        <div className={`flex ${isMobile ? "flex-row" : "flex-col"} gap-4 mt-3 items-cente`}>
          <a
          ...
          >
            <FaLinkedin size={20} />
            {!isMobile && <span className="ml-2">linkedin.com/in/himanshu-g12/</span>}
          </a>
          <a
            href="https://www.youtube.com/@fractalVerse12"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="YouTube"
            className="flex items-center"
          >
            <FaYoutube size={24} />
            {!isMobile && <span className="ml-2">youtube.com/@fractalVerse12</span>}
          </a>
          <a
        ...
        <div className={`flex ${isMobile ? "flex-row" : "flex-col"} gap-4 mt-3`}>
